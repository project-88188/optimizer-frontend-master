...
export class ProgramTableComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    merge(this.sort.sortChange, this.term$.pipe(debounceTime(1000), distinctUntilChanged()), this.paginator.page).subscribe(data=>{
      ...
      if(this.isLoggedIn) {
        ...
        this.tableService!.getDataProgram(this.sort.active, this.sort.direction, this.paginator.pageIndex,this.paginator.pageSize, 
